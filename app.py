...
CAMEROON_SUBJECTS = [
    ...
    'ict', 'geology', 'technical drawing', 'food science', 'nutrition', 'agricultural scpience',
...
def recommend():
    try:
        ...
        # Set subjects with safe conversion
        for subject in data['subjects']:
            subject = str(subject).lower()  # Ensures no AttributeError from int
